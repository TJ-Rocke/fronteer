        ...
        >
          ...
          <div className="flex lg:hidden">
            ...
            >
              ...
              <Bars3Icon aria-hidden="true" className="size-6 text-[#e0e7ff]" />
            </button>
          </div>
                ...
                <div className="space-y-2 py-6">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-[#e0e7ff] hover:bg-gray-900"
                    >
                      {item.name}
                    </a>
                  ))}
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#60a5fa] to-[#9089fc] opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]"
          />
        </div>
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-35">
          ...
          <div className="text-center">
            <h1 className="text-balance text-5xl font-semibold tracking-tight text-white sm:text-7xl">
              Leetcode for Frontend Engineers
            </h1>
